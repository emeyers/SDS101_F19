...
download_class_data <- function(file_name){
  ...
  base_path <- "https://raw.githubusercontent.com/emeyers/SDS101_F19/master/class_data/"
...
download_class_code <- function(class_number){
  ...
  base_path <- "https://raw.githubusercontent.com/emeyers/SDS101_F19/master/class_code/"
...
download_homework <- function(homework_number){
  ...
  base_path <- "https://raw.githubusercontent.com/emeyers/SDS101_F19/master/homework/"
